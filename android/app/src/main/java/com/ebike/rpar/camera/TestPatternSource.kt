        ...
        job = scope.launch(Dispatchers.Default) {
            ...
            while (isActive) {
                ...
                val meta = FrameMeta(
                    ...
                    iso = 100,
                    focalLengthMm = 6.7,
                    focusDistanceDiopters = 0.05,
                    afState = "FOCUSED",
                    aeState = "CONVERGED",
                    awbState = "CONVERGED",
                    cropRegion = intArrayOf(0, 0, width, height),
                    stabilizationMode = StabilizationMode.OFF,
                    width = width,
                    height = height,
                    availability = mapOf(
                        "sensor_timestamp" to true, "exposure" to true, "iso" to true,
                        "focal" to true, "af" to true, "ae" to true, "awb" to true, "crop" to true,
                        "ois" to false, "eis" to false,
                    ),
                )
