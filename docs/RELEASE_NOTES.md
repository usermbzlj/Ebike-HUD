...
- `rpar export-bump-tflite` 默认 640² ONNX（与桌面 YOLO-World 对齐；Ultralytics LiteRT 仅 Linux/macOS）；手机 HybridEngine 在图加载成功时替换启发式坑/带/盖，NNAPI 优先；Camera2 分析流补 UV 供 RGB letterbox
